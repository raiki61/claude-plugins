...
HOOKS = ("on_init", "on_new_round", "on_answer", "on_answer_in_round", "answer_detail", "on_unattended", "on_stop", "on_thickness", "finalize", "check_record",
         "init_record", "add", "check_inputs")
