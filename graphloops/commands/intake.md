...
本文・差分・記録の中身・パスは残さない。標準エラーの頭は、環境変数 `GRAPHLOOPS_INTAKE_STDERR=1` を立てたときだけ 500 字まで残す。置き場・残す欄・止めない約束は [README の「踏んだ問題を残す」](../README.md#踏んだ問題を残すgraphloopsintake) に在る。
