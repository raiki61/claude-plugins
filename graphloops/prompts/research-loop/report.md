...
1. 冒頭に平易版（専門語なしで何の話か・どう解いたか・なぜ正しいと言えるか）。停止した run・無人実行では、その前に「要人間判断」として process.human_items と decisions.human_only を列挙。収束・停止を問わず、人の方針の文書が init の後に変わっていれば（process.policy_change）、そのことと差分・写しの置き場を冒頭に 1 行で書く。
